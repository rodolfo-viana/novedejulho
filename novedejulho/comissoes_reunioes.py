...
def main():
    ...
    dataset = dataset.rename(columns={
        'IdReuniao': 'id_reuniao', 'IdComissao': 'id_comissao',
        'IdPauta': 'id_pauta', 'NrLegislatura': 'nr_legislatura',
        'NrConvocacao': 'nr_convocacao', 'TipoConvocacao': 'tp_convocacao',
        'Data': 'dt', 'CodSituacao': 'cd_situacao',
        'Situacao': 'situacao', 'Presidente': 'presidente'
    })
    save_files(dataset, 'comissoes_permanentes_reunioes')
